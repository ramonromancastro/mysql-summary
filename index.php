...
<?php
    ...
    function writeCircle($type='ok',$size=16,$title=null){
    ...
    function sortStats($a, $b){ return strcmp($a["test"], $b["test"]); }
    # -------------------------------------------------
    # MAIN CODE
    # -------------------------------------------------
?>
        ...
        <div class="w3-col l6 m12 s12 flex-item w3-section">
            <div class="w3-card w3-white w3-round w3-padding flex-content">
                ...
                <table class="w3-table w3-striped w3-small w3-bordered">
                    ...
                    <tbody>
                        <tr><td>Password validation <a title="Documentación oficial" target=_blank rel="noopener noreferrer" href="https://dev.mysql.com/doc/refman/<?php preg_match('/\d+\.\d+/',$status['version'], $match); echo $match[0]; ?>/en/validate-password.html">[?]</a></td><td><?php echo writeCircle($feature_validate_password)." $feature_validate_password$feature_validate_password_value"; ?></td></tr>
                        <tr><td>Perfomance schema <a title="Documentación oficial" target=_blank rel="noopener noreferrer" href="https://dev.mysql.com/doc/refman/<?php preg_match('/\d+\.\d+/',$status['version'], $match); echo $match[0]; ?>/en/performance-schema.html">[?]</a></td><td><?php echo writeCircle($performance_schema)." $performance_schema"; ?> </td></tr>
                        <tr><td>SSL availability</td><td><?php echo writeCircle($ssl_availability)." $ssl_availability"; ?> </td></tr>
                        <tr><td>Error log</td><td><?php echo $status['log_error']; ?> </td></tr>
                        <tr><td>General log</td><td><?php echo writeCircle($general_log)." $general_log"; ?> </td></tr>
                        <tr><td>Slow query log</td><td><?php echo writeCircle($slow_query_log)." $slow_query_log"; ?> </td></tr>
